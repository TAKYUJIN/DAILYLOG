...
<nav class="navbar navbar-default navbar-expand-lg navbar-light">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		<ul class="nav navbar-nav" >
			...
			<li class="nav-item"><a href="loginbutton.me" class="nav-link" style="padding-right:0px;">북마크</a></li>			
			<li class="nav-item"><a href="loginbutton.me" class="nav-link" style="padding-right:0px;">구독</a></li>	
			<li class="nav-item"><a href="loginbutton.me" class="nav-link" style="padding-right:0px;">최근 활동</a></li>	
			<li class="nav-item"><a href="loginbutton.me" class="nav-link" style="padding-right:0px;">좋아요 영상</a></li>
			<li class="nav-item"><a href="loginbutton.me" class="nav-link" style="padding-right:0px;">로거 스튜디오</a></li>
		</ul>
