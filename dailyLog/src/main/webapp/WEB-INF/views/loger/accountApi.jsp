...
<body>
	<div id="primary-info5" class="input-form">
		<table style="width:700px;" class="accountTable">
			<tr>
				...
				<tr>
					...
					<td>
						...
						style="border: 1px solid #ddd; background: #f8f8f8; padding: 10px; margin-left: 10px; width: 440px; height: 50px;">
							...
							style="display:none">
							<label id="sbm-no"
							style="background:#FBC52C;color:white;border-radius:3px;padding:3px;font-size:15px;">미인증</label>
							<label id="sbm-ok"
							style="background:#192466;color:white;border-radius:3px;padding:3px;display:none;font-size:15px;">인증됨</label>
						</div>
						<div align="center">
						<br>
