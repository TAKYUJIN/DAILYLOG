...
<head>
	...
	<meta property="og:image" content="//res.afreecatv.com/images/common/afreecatv_logo.jpg" />
	...
	<meta name="twitter:image" content="//res.afreecatv.com/images/common/afreecatv_logo.jpg">
	...
	<link rel="alternate" href="//www.afreecatv.com" hreflang="x-default" />
	<!--<link rel="alternate" href="//www.afreecatv.com/?lang=ko_KR" hreflang="ko" /> 171102 SEO TEST-->
	<link rel="shortcut icon" type="image/x-icon" href="//res.afreecatv.com/afreeca.ico"/>
	<link rel="stylesheet" type="text/css" href="//res.afreecatv.com/css/global/flashplayer/pop_layer.css" />
	<link rel="stylesheet" type="text/css" href="//res.afreecatv.com/css/global/afmain/afmain.css"/>
	<link rel="stylesheet" href="//res.afreecatv.com/css/global/afmain/jquery.mCustomScrollbar.css"/>
	<script type="text/javascript" src="//res.afreecatv.com/script/common/jquery.js"></script>
	<script type="text/javascript" src="//res.afreecatv.com/script/afmain/jquery.mCustomScrollbar.concat.min.js"></script>
	<script type="text/javascript" src="//res.afreecatv.com/script/afmain/jquery.mousewheel.min.js"></script>
	<script type="text/javascript" src="//res.afreecatv.com/script/afmain/mousewheelStopPropagation.min.js"></script>
	<script type="text/javascript" src="//res.afreecatv.com/script/new_main/_config.js"></script>
	<script type="text/javascript" src="//res.afreecatv.com/script/new_main/afreecacook.js"></script>
	<script type="text/javascript" src="//res.afreecatv.com/main/main_category_ko_KR.js"></script>
	<!-- 국내와 분기하기위에 상단에 선언 <script type="text/javascript" src="//live.afreecatv.com/api/get_broadlist_main_info.php?type=script"></script> -->
	<script type="text/javascript" src="//res.afreecatv.com/main/get_broadlist_main_info_ko_KR.js?26114629"></script>
	...
	<script type="text/javascript" src="//res.afreecatv.com/data/afreeca_notice_portlet_ko_KR.js" charset="euc-kr"></script>
	<script type="text/javascript" src="//res.afreecatv.com/main/simple_page.js"></script>
	<script type="text/javascript" src="//static.afreecatv.com/asset/library/requirejs/2.1.8/require.js"></script>
	<script type="text/javascript" src="//static.file.afreecatv.com/pc/ko_KR/main_broad_list.js"></script>
	<!-- <script type="text/javascript" src="//live.afreecatv.com/script/locale/ko_KR/broad_category.js"></script> -->
	<!-- <script type="text/javascript" src="//live.afreecatv.com/script/pop_open.js" charset="euc-kr"></script> -->
	<!--메인 화면 구성을 하는 모든 스크립트를 노출 시키는 스크립트를 모아놓은 API / 파라미터로 서비스별 최적화-->
	<script type="text/javascript" src="//static.afreecatv.com/asset/service/get_service_script.php?lang=ko_KR"></script>
	<!--
	<script type="text/javascript" src="//static.afreecatv.com/asset/service/gnb/gnb_common.js"></script>
	<script type="text/javascript" src="//static.afreecatv.com/asset/service/gnb/gnb.js"></script>
	...
	<script type="text/javascript" src="//res.afreecatv.com/script/statistics/afreeca.front.statistics.js"></script>
	...
	function initSeasonalBnr()
	{
		...
		if(oMainData.MAIN_SEASONAL_BNR_RESULT == 1)
		{
			...
			{
				$('h1#logo').html('<a href="//www.afreecatv.com"><img src="//res.afreecatv.com/images/afmain/logo_main.gif" width="210" height="65" title="afreecaTV">');
			}
		}
		else
		{
	...
	function initMainCate()
	{
		...
		if(oMainCategory.result == 1)
		{
			...
			$.each(oMainCategory.data, function(i, oCategory) {
				if(oCategory.menu_type != "127") {
					szLiClass = '';
					var j = i+1;
					if(i == 0){
						szLiClass = 'class="line_t"';
					}
					else{
						if((j < oMainCategory.total_count) && oMainCategory.data[j].menu_type == "127"){
							szLiClass = 'class="line"';
						}
					}
					var szTempHtml = '<li ' + szLiClass + ' id="'+ oCategory.menu_id +'" name="'+ oCategory.menu_name +'" menu_idx="'+ oCategory.menu_idx +'" \n\
						menu_type="'+oCategory.menu_type+'" action_type="'+ oCategory.action_type +'" action_content="'+ oCategory.action_content +'">';
					if(oCategory.action_type == "4"){
						szTempHtml += '<a href="'+ oCategory.action_content +'" target="new">';
					}else{
						szTempHtml += '<a href="'+ oCategory.action_content +'">';
					}
					szTempHtml += '<em class="ic_'+ oCategory.menu_id +'"></em>'+ oCategory.menu_name +'<span class="arrow"></span>';
					szTempHtml += '</a></li>';
			...
			aCateHtml.push('<div class="player_download" id="playerSetupKor" style="display:block">');
			aCateHtml.push('<a href="javascript:;">');
			aCateHtml.push('<em></em>설치형 플레이어');
			aCateHtml.push('</a></div>');
			if(szLang == "ko_KR" ) {
                aCateHtml.push('<div class="basecamp">');
    			aCateHtml.push('<a href="javascript:;">');
    			aCateHtml.push('<em></em>VR 플레이어');
    			aCateHtml.push('</a></div>');    
            }

			szCate = aCateHtml.join('');
            $('div#categoryScrollArea').html(szCate).mCustomScrollbar({
				axis:"yx",
		 		theme:"minimal-dark",
		 		scrollInertia:100,
...
<!--vr플레이어 layer-->
<div id="layer_vr" style="display:none">
	<span class="txt">VR전용 헤드셋이 준비 되셨나요?</span>
	<a href="#n" class="go_vrbs">공식 방송국가기</a>
	<a href="#n" class="go_basecamp" id="basecampPlay">VR플레이어 실행하기</a>
	<button type="button" class="btn_close">닫기</button>
</div>

<!-- 중국 vpn 시청가능 안내 -->
	<div id="layer_zh_info" style='display:none'>
		<div class="dim" id='backlayer'></div>	
		<div class="ui-pop pop_chnoti">	
		<div class="pop-body">
			在中国的用户进入 https://www.afreecatv.com<br />进行注册，按”注册”键后显示网页错误，<br />
	但注册的账号可以正常登入。<br />目前中国IP不能观看直播,请使用梯子观看!
		<p class="close_ck"><input type="checkbox" id="chinatodayclose"><label for="">今天不再显示</label></p>
		</div>
		<div class="pop-btn">		
...
<div id="studioSelect" class="studio_selectbox" style="display:none">
	...
	<div class="studio_btn_wrap">
		<!-- 2017-0621 레이어 추가 -->
		<a href="#" id="avaPlay" class="btn_cast_help"> <span>AVA 로 꿀잼 방송 하기!<em></em> </span></a>
		<a href="http://aqua.afreecatv.com" class="btn_aqua" target="_blank"><span>전자여성으로 방송화면 꾸미기!<em></em> </span></a>
	</div>
	<div class="bj_edu"><a href="//newbj.afreecatv.com" target="_blank">신입BJ 지원센터 바로가기</a></div>
</div>
<!-- //방송하기 레이어 -->

<!-- 장기구독자 알림 레이어 -->
<div class="ui-pop gd_alarm" id="galarm_layer" style="display:none">
	<div class="pop-body">
		<h2>축하드립니다!</h2>
		<p><strong>장기 구독자 선물 대상자</strong>입니다.<br>구독자를 위한 특별한 아이템을 받으시려면<br> <a href="//subs.afreecatv.com">구독자 선물 페이지</a>에서 확인해보세요!</p>
	</div>
	<div class="pop-btn line">
		<label for="todayclose"><input type="checkbox" id="todayclose">30일 동안 보지 않기</label>
...
<div id="alarm_broadcast" style="display: none;">
	...
	<div class="ar_bottom">
		...
		<a href="//help.afreecatv.com/atv.php?type=exMailQuestion" >1:1 문의하기</a>
	</div>
...
<div id="View_after" style="display: none;">
	<div class="view_after_title">
		...
		<span id="vod_later">보고 싶은 VOD나, 아직 보지 않은<br>VOD를 목록에 등록해 두고  언제든 간편하게 찾아보세요!</span>
		<span id="live_later">라이브 방송을 시청할 수 없는 상황일 때<br> 목록에 담아두고 원하는 시간에 손쉽게 찾아 보세요!</span>
	</div>
	<div class="view_after_contents">
		<a href="javascript:;">VOD의 “나중에 보기” 메뉴</a>에서<br>등록 한 영상을 확인 하실 수 있습니다.	</div>
...
<!-- 구독자 전용 닉네임 변경 -->
<div class="layer_s gdnick_layer" id="gdNickLayer" style="display: none;"><div class="layer_in">
	<strong class="title">구독자 전용 닉네임 변경</strong>
	<input type="hidden" id="subnick_bj_id" name="subnick_bj_id" value=""/>
	<input type="hidden" id="default_nick" name="default_nick" value=""/>
	<div class="layer_ac">
		<span class="fts11">구독자 전용 닉네임을 입력해주세요.</span><br />
		<span class="color_red fts11" id="textError" style="display: none;">허용 길이 이상을 입력했습니다.</span>
	</div>
...
<div id="wrap">
	...
	<div id="header">
		...
		<fieldset>
		<legend>검색</legend>
			<form name="oSearchForm" action="//www.afreecatv.com/total_search.html" accept-charset="" onsubmit="return false;" method="post">
	...
	<div id="sideArea">
		<div class="category_area log_scroll">
			<div class="inner">
				<div id="categoryScrollArea" class="scrollarea"><script type="text/javascript">initMainCate();</script>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="container">
		...
		<div id="topBnrArea" class="banner_area" style="display:none;">
			...
			<div class="line"></div><!-- 180524 라인제거 -->
		...
		<div id="wideArea" class="content_area">
			...
			<div id="staffPicksDetail" style="display:none;">
				...
				<div class="sv_area">
					...
					<ul class="tab_list short">
						...
						<li role="vod"><a href="javascript:;">VOD</a></li>
					</ul>
				</div>
				<div class="listarea">
			...
			<div class="hotissue" id="hotArea" style="display: none;">
				...
				<li id="live_slider_btn" class="on"> <a href="#liveSlider"  >라이브</a></li>
				<li id="vod_slider_btn"><a href="#vodSlider"  >VOD</a></li>
				</ul>
				<div class="control">
			...
			<ul id="hashtagTab" class="tab_ct" style="display:none;">
				...
				<li data-type="hashtag_vod"><a id="hashtag_vod" href="javascript:;">VOD</a></li>
			</ul>

			<!-- 즐겨찾기 구독 배너 -->
			<div id="subscriptionBanner" class="banner" style="background:#006cff; display:none;"><a href="http://item.afreecatv.com/subscription.php" target="_blank"><img src="//res.afreecatv.com/images/afmain/banner_gd.jpg"></a></div>
			<!-- 즐겨찾기 구독 배너 -->
			...
			<!-- 방송중인 즐찾리스트 정렬 (default hide)-->
			<div id="favorite_sv_area" class="sv_area" style="display:none;">
				<h2 class="blind">정렬보기</h2>
				<ul class="tab_list">
				<li class="on" role="total_view_cnt">
					<a href="javascript:;" ><span >시청인원순</span>
					<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
				<li role="broad_start">
					<a href="javascript:;"><span >최신방송순</span>
					<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
				</ul>
				<button class="btn_delete_all" style="display:none;"><span>전체삭제</span></button>
				<button class="btn_reload"><span class="ir">새로고침</span></button>
			...
			<!-- 카테고리 고정 배너 -->
			<div class="banner_link" id="div_cate_banner" style="display:none;"></div>
			<!-- 게임배너 -->
			...
			<!-- //새로고침 -->
			<div id="broadlist_area" class="onAir">
				<div class="listarea">
					<ul></ul>
			...
			<div id="hashtagAll_list_area" style="display:none;">
				...
				<div class="hash_tit_area">
					<h3>VOD</h3>
					<a href="javascript:;" class="btn_more" id="hashtagVod_more">VOD 더보기<em></em></a>
				</div>
			...
			<div id="fav_vodlist_area" class="onAir" style="display:none;"></div>
			<div id="fav_fixlist_area" class="onAir" style="display:none;"></div>
			...
			<div class="bjissue_banner" style="display:none;"></div>

			<!-- 구독한 BJ 영역 -->
			<div id="subs_vodlist_area" style="display:none;"></div>
			<div id="subs_offair_area" style="display:none;"></div>
			<!-- // 구독한 BJ 영역 -->

			<!-- 팬클럽 가입 BJ 영역 -->
			<div id="fan_vodlist_area" style="display:none;"></div>
			<div id="fan_offair_area" style="display:none;"></div>
			<!-- // 팬클럽 가입 BJ 영역 -->
		</div>
	</div>
	<!-- //content -->
...
<script type="text/javascript">
	var _szUserId = 'dpwls48';
	var isLogin = 1;
	var adPlayer = null;	// 메인 슬라이딩 광고 TI 영상 플레이어 변수
	...
	$(window).ready(function(){
		...
		$(function() {
			...
			// 광고tag주소 국내/해외 설정
			szAdTagUrl = '//pa.afreecatv.com/RealMedia/ads/adstream_sx.ads/pc.web.in/banner/main@Top1?mid_id=afreecaAd&aftvlid=b7b3787b09f36e77201d20a6200b31d3';
			if (szLang != "ko_KR"){
				szAdTagUrl = '//pa.afreecatv.com/RealMedia/ads/adstream_sx.ads/pc.webg.in/banner/main@Top1?mid_id=afreecaAd&aftvlid=b7b3787b09f36e77201d20a6200b31d3';
			}
			if ((checkSimple("main","ad_banner")) && (_szCurHash =="" || _szCurHash == "all") && 1)
			{
				$.getScript(szAdTagUrl, function () {
					try {
						// 광고 영상 URL 있을 경우에만 광고 플레이어 호출함
						if (typeof szVodUrl != "undefined") {
							$('head').append( $('<link rel="stylesheet" type="text/css"/>').attr('href', '//res.afreecatv.com/css/global/afreecatv_player/afreecatv_player.css') );
							$.ajax({
								dataType: 'script',
								cache: true,
								url: '//static.afreecatv.com/asset/app/adplayer/AdPlayer.min.js'
							});
						}
					} catch(e) { }
				});
	...
	require.config({
		...
		, paths: {
			...
			, subsBJ : 'app/main/subsbj.global'
			, fanBJ : 'app/main/fanbj.global'
			, foru : 'app/main/foru.global'
			, doT :	'app/main/doT.min'
			, view : 'app/main/view.global.broadlist'
			, viewforu : 'app/main/view.foru'
			, viewsubsbj : 'app/main/view.subsbj'
			, viewfanbj : 'app/main/view.fanbj'
			, banner : 'app/main/banner.category'
			, bxSlider : '//res.afreecatv.com/script/common/jquery.bxslider.4.1.2.min'
			, mousewheel : '//res.afreecatv.com/script/afmain/jquery.mousewheel.min'
			, Highcharts : '//res.afreecatv.com/script/afmain/highcharts'
		}
		, shim: {
			'bxSlider' : {
				deps: ['jquery']
		...
		, deps: ['//static.afreecatv.com/asset/service/config/config.js']
		, callback: function() {
	...
	<div class="cast_box">
		<a href="{{=it.VIEW_URL}}" onclick="javascript:{{=it.CLICK_FNC}}" class="box_link" target="_blank">
			...
			<div class="ic_wrap">
				...
				{{? it.VISIT_BROAD == '1' }}<span class="ic_allow">탐방허용</span>{{?}}
			</div>
...
<script id="tpl_notice_speech_bubble" type="text/x-dot-template">
	<div class="notice_area">
		{{=it.BUBBLE_LIST}}
	</div>
</script>

<script id="tpl_notice_speech_bubble_list" type="text/x-dot-template">
	<dl>
	<dt><a href="{{=it.NOTICE_URL}}" target="_blank">알려드립니다.</a></dt>
	<dd><a href="{{=it.LINK_URL}}" target="_blank"><strong>[안내] </strong>{{=it.SUBJECT}}</a></dd>
	</dl>
</script>
...
<script id="message_hashtag_vod_none" type="text/x-dot-template">
	<span class="ic_nocast"></span>
	<p class="txt01"><span  >VOD가 없습니다.</span></p>
</script>

<script id="message_subs_none" type="text/x-dot-template">
	<span class="ic_gudok"></span>
	<p class="txt01">구독한 BJ가 없습니다.</p>
	<p class="txt02">내가 좋아하는 BJ를 구독하고 본방 입장, 구독 전용 닉네임, 시그니처 이모티콘 등<br>구독자만을 위한 아주 특별한 혜택을 만나보세요!</p>
</script>

<script id="message_fanclub_none" type="text/x-dot-template">
	<span class="ic_fanclub"></span>
	<p class="txt01">가입한 팬클럽이 없습니다.</p>
	<p class="txt02">BJ에게 별풍선을 선물하면 선물한 BJ의 팬클럽에 가입됩니다!<br>팬클럽은 팬클럽 공개 게시판을 이용할 수 있고, 팬클럽만의 특별한 채팅 글자색으로 채팅이 돋보입니다.</p>
</script>
...
즐겨찾기는 1,200개까지만 추가가 가능합니다. 즐겨찾기 정리 후 추가해주세요.</script>

<script id="message_favorite_topfix_add" type="text/x-dot-template">
목록 상단 고정 완료 되었습니다.</script>

<script id="message_favorite_topfix_del" type="text/x-dot-template">
목록 상단 고정 해제 되었습니다.</script>
...
<li>
	<div class="cast_box">
		...
		<div class="nick_wrap">
			<a href="javascript:;" user_id="{{=it.USER_ID}}" class="nick">{{=it.USER_NICK}}</a>
			{{? it.IS_SUBSCRIPT == '1' }}<span class="ico_subscribe">구독</span>{{?}}{{? it.IS_FANCLUB == '1' }}<span class="ico_fan">팬</span>{{?}}
		</div>
...
<h3 class="title_s" style="display:none;"><span>방송중</span></h3>
<div class="listarea" id="FavLiveList">
	<ul>
		{{=it.LISTITEM}}
	</ul>
	<div class="more_list" style="display:none;"><a href="javascript:;"><span>더보기</span><em></em></a></div>
...
<script id="favorite_list_body_nolist" type="text/x-dot-template">
<div class="tit_sv_area">
	<h3 class="title_s"><span>방송중</span></h3>
	<button class="btn_reload"><span class="ir">새로고침</span></button>
</div>
<p class="favor_noLst">현재 방송 중인 즐겨찾기 BJ가 없습니다.</p>
</script>
<script id="favorite_vod_list" type="text/x-dot-template">
<li>
	<div class="cast_box">
		<a href="{{=it.LINK_URL}}"  onclick="javascript:{{=it.CLICK_FNC}}" class="box_link" target="_blank">
		<span class="thumb"><img src="{{=it.THUMB}}" onerror="this.src='{{=it.THUMB_ERROR}}'" title=""></span>
...
<h3 class="title_s"><span>즐겨찾기한 BJ의 VOD</span></h3>
...
<script id="favorite_vod_body_nolist" type="text/x-dot-template">
<h3 class="title_s"><span>즐겨찾기한 BJ의 VOD</span></h3>
<p class="favor_noLst">즐겨찾기 한 BJ의 VOD가 없습니다.</p>
</script>
...
<h3 class="title_s"><span  >즐겨찾기 전체</span></h3>
<div class="sv_area">
	<h2 class="blind">정렬보기</h2>
		<ul class="tab_list order_fav_list">
			<li data-list-type='favorite_no'><a href="javascript:;">최신등록순			<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
			<li data-list-type='user_nick'><a href="javascript:;">닉네임순			<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
			<li data-list-type='user_id'><a href="javascript:;">아이디순			<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
			<li data-list-type='broad_start'><a href="javascript:;">최근방송순			<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
			<li data-list-type='total_view_cnt'><a href="javascript:;">누적시청자순			<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
		</ul>
</div>
<div class="listarea favor_all">
	<ul></ul>
	<div class="more_list" style="display:none" ><a href="javascript:;">더보기<em></em></a></div>
</div>
</script>
<script id="favorite_broad_on_item" type="text/x-dot-template">
<li>
	<div class="ready_box {{=it.IS_TOP_FIX}}">
		<a href="{{=it.STATION_URL}}" target="_blank">
			<span class="thumb">
				<img src="{{=it.STATION_LOGO}}" onerror="this.src='{{=it.THUMB_ERROR}}'" width="62" height="62" title="">
			</span>
			<span class="nick" user_id="{{=it.USER_ID}}">{{=it.USER_NICKSUB}}
				{{? it.IS_SUBSCRIPT == '1' }}<span class="ico_subscribe">구독</span>{{?}}{{? it.IS_FANCLUB == '1' }}<span class="ico_fan">팬</span>{{?}}
			</span>
		...
		<a href="javascript:;" id="favorite_delete" class="cast_delete"><span class="favorite"><em>즐겨찾기 삭제</em></span></a>
		<div class="btn_live">
			<a href="{{=it.VIEW_URL}}" onclick="{{=it.CLICK_FNC}}" class="cast_live" target="_blank"><span>LIVE 시청하기</span></a>
		</div>
		<a href="javascript:;" class="cast_fixing" favorite_no="{{=it.FAVORITE_NO}}"><span><em>목록 상단고정</em></a>
	</div>
</li>
</script>
<script id="favorite_broad_off_item" type="text/x-dot-template">
<li>
	<div class="ready_box {{=it.IS_TOP_FIX}}">
		<a href="{{=it.STATION_URL}}" target="_blank">
			<span class="thumb">
...
<li broad_no="{{=it.BROAD_NO}}">
	<div class="cast_box">
		<a href="{{=it.VIEW_URL}}" class="box_link" target="_blank">
			<span class="grbox"></span>
			<div class="ic_wrap">
				{{? it.BROAD_TYPE == 40 }}<span class="ic_ppv"><em>유료</em></span>
				{{?? it.RESOLUTION == '1080' }}<span class="ic_1080p">1080p</span>{{??}}{{?}}
		...
		<div class="nick_wrap">
			<a user_id="{{=it.USER_ID}}" class="nick">{{=it.USER_NICK}}</a>
				{{? it.IS_SUBSCRIPT == '1' }}<span class="ico_subscribe">구독</span>{{?}}{{? it.IS_FANCLUB == '1' }}<span class="ico_fan">팬</span>{{?}}
		</div>
...
<script id="subscription_broad_off_body" type="text/x-dot-template">
<h3 class="title_s">구독한 BJ 전체</h3>
<div class="sv_area">
	<h2 class="blind">정렬보기</h2>
	<ul class="tab_list order_sub_list">
		<li data-list-type='pay_date'><a href="javascript:;"><span>최신구독순</span>
		<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
		<li data-list-type='user_nick'><a href="javascript:;"><span>닉네임순</span>
		<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
		<li data-list-type='user_id'><a href="javascript:;"><span>아이디순</span>
		<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
		<li data-list-type='broad_start'><a href="javascript:;"><span>최신방송순</span>
		<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
		<li data-list-type='total_view_cnt'><a href="javascript:;"><span>시청인원순</span>
		<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
	</ul>
	<div class="more_lk"><a href="javascript:;">구독 결제정보</a></div>
</div>
<div class="listarea subs_all" style="">
	<ul></ul>
	<div class="more_list" style="display:none"><a href="javascript:;">더보기<em></em></a></div>
</div>
</script>
<script id="subscription_broad_on_item" type="text/x-dot-template">
<li>
	<div class="ready_box {{=it.IS_TOP_FIX}}">
		<a href="{{=it.STATION_URL}}" target="_blank">
			<span class="thumb">
			...
			<span class="nick" user_id="{{=it.USER_ID}}">{{=it.USER_NICKSUB}}
				<span class="ico_subscribe">구독</span>{{? it.IS_FANCLUB == '1' }}<span class="ico_fan">팬</span>{{?}}
			</span>
			<span class="afid">{{=it.USER_ID}}</span>
			<span class="afnick">구독 닉네임 : <span>{{=it.SUB_NICK}}</span><button class="btn_nick" sub_nick="{{=it.SUB_NICK}}" default_nick="{{=it.DEFAULT_NICK}}">구독 닉네임 변경</button></span>
			<span class="date_area">
				<span class="first">구독일 : {{=it.PAY_DATE}} <em>({{=it.MONTH}})</em><button class="btn_mygd" bj_id="{{=it.USER_ID}}">구독정보 보기</button></span>
			</span>
		</a>
		<a href="javascript:;" class="cast_fav" favorite_no="{{=it.FAVORITE_NO}}"><span><em>{{? it.FAVORITE_NO > 0 }}즐겨찾기 해제{{??}}즐겨찾기 추가{{?}}</em></span></a>
		<div class="btn_live_s">
			<a href="{{=it.VIEW_URL}}" onclick="{{=it.CLICK_FNC}}" class="cast_live" target="_blank"><span>LIVE 시청하기</span></a>
		</div>
		<a href="javascript:;" class="cast_fixing" payment_no="{{=it.PAYMENT_NO}}"><span><em>{{? it.IS_FIX > 0 }}목록 상단해제{{??}}목록 상단고정{{?}}</em></a>
	</div>
</li>
</script>
<script id="subscription_broad_off_item" type="text/x-dot-template">
<li>
	<div class="ready_box {{=it.IS_TOP_FIX}}">
		<a href="{{=it.STATION_URL}}" target="_blank">
			<span class="thumb">
...
<script id="subscription_vod_body" type="text/x-dot-template">
<h3 class="title_s"><span>구독한 BJ의 VOD</span></h3>
<div class="hotissue" id="hotArea">
	<div class="control favpg">
		<button id="toggleSubsVodList" class="stopButton">stop</button>
		<button class="prev" id="btnPrevVod">이전</button>
		<button class="next" id="btnNextVod">다음</button>
	</div>

	<div class="listarea">
		<ul id="subsVodSlider" class="hot_issue">
			{{=it.LISTITEM}}
		</ul>
	</div>
</div>
</script>
<script id="sub_list_body_nolist" type="text/x-dot-template">
<div class="tit_sv_area">
	<h3 class="title_s"><span>방송중</span></h3>
	<button class="btn_reload"><span class="ir">새로고침</span></button>
</div>
<p class="favor_noLst">현재 방송 중인 BJ가 없습니다.</p>
</script>
<script id="sub_vod_body_nolist" type="text/x-dot-template">
<h3 class="title_s"><span>구독한 BJ의 VOD</span></h3>
<p class="favor_noLst">구독한 BJ의 VOD가 없습니다.</p>
</script>
<script id="fanclub_vod_body" type="text/x-dot-template">
<h3 class="title_s"><span>팬클럽 가입 BJ의 VOD</span></h3>
<div class="hotissue" id="hotArea">
	<div class="control favpg">
		<button id="toggleFanVodList" class="stopButton">stop</button>
		<button class="prev" id="btnPrevVod">이전</button>
		<button class="next" id="btnNextVod">다음</button>
	</div>

	<div class="listarea">
		<ul id="fanVodSlider" class="hot_issue">
			{{=it.LISTITEM}}
		</ul>
	</div>
</div>
</script>
<script id="fanclub_vod_body_nolist" type="text/x-dot-template">
<h3 class="title_s"><span>팬클럽 가입 BJ의 VOD</span></h3>
<p class="favor_noLst">팬클럽 가입 BJ의 VOD가 없습니다.</p>
</script>
<script id="fanclub_broad_off_body" type="text/x-dot-template">
<h3 class="title_s">팬클럽 가입 BJ 전체</h3>
<div class="sv_area">
	<h2 class="blind">정렬보기</h2>
	<ul class="tab_list order_fan_list">
		<li data-list-type='fan_date'><a href="javascript:;"><span>팬클럽 가입순</span>
		<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
		<li data-list-type='user_nick'><a href="javascript:;"><span>닉네임순</span>
		<span class="order_icon asc"> ↑</span><span class="order_icon desc"> ↓</span></a></li>
		<li data-list-type='user_id'><a href="javascript:;"><span>아이디순</span>
...
<div class="listarea fanclub_all" style="">
	<ul></ul>
	<div class="more_list" style="display:none"><a href="javascript:;">더보기<em></em></a></div>
</div>
</script>
<script id="fanclub_broad_on_item" type="text/x-dot-template">
<li>
	<div class="ready_box {{=it.IS_TOP_FIX}}">
		<a href="{{=it.STATION_URL}}" target="_blank">
			<span class="thumb">
			...
			<span class="nick" user_id="{{=it.USER_ID}}">{{=it.USER_NICKSUB}}
				{{? it.IS_SUBSCRIPT == '1' }}<span class="ico_subscribe">구독</span>{{?}}<span class="ico_fan">팬</span>
			</span>
			<span class="afid">{{=it.USER_ID}}</span>
			<span class="date_area">
				<span class="first">팬클럽 가입일 : {{=it.FAN_DATE}}</span>
			</span>
		</a>
		<a href="javascript:;" class="cast_fav" favorite_no="{{=it.FAVORITE_NO}}"><span><em>{{? it.FAVORITE_NO > 0 }}즐겨찾기 해제{{??}}즐겨찾기 추가{{?}}</em></span></a>
		<div class="btn_live_s">
		...
		<a href="javascript:;" class="cast_fixing" gift_no="{{=it.GIFT_NO}}"><span><em>{{? it.IS_FIX > 0 }}목록 상단해제{{??}}목록 상단고정{{?}}</em></a>
	</div>
</li>
</script>
<script id="fanclub_broad_off_item" type="text/x-dot-template">
<li>
	<div class="ready_box {{=it.IS_TOP_FIX}}">
		<a href="{{=it.STATION_URL}}" target="_blank">
			<span class="thumb">
...
<script id="category_list" type="text/x-dot-template">
	<li class="{{=it.LI_CLASS}}" menu_idx="{{=it.MENU_IDX}}" menu_id="{{=it.MENU_ID}}" menu_type="{{=it.MENU_TYPE}}" parent_idx="{{=it.PARENT_IDX}}" action_type="{{=it.ACTION_TYPE}}" cate_no="{{=it.CATE_NO}}">
	<a href="javascript:;">{{=it.CATE_NAME}}</a></li>
</script>

<script id="category_list_action" type="text/x-dot-template">
	<li class="{{=it.LI_CLASS}}" id="{{=it.MENU_ID}}" name="{{=it.CATE_NAME}}" menu_idx="{{=it.MENU_IDX}}" parent_idx="{{=it.PARENT_IDX}}">
	<a href="{{=it.CATE_NO}}">{{=it.CATE_NAME}}</a></li>
</script>

<script id="sub_category_list_body" type="text/x-dot-template">
<ul class="space_t sub_cate">{{=it.LISTITEM}}</ul>
</script>

<script id="tab_category_list_body" type="text/x-dot-template">
...
<!------------------ 2018-06-20 추가  -------->
<script id="foru_history_body" type="text/x-dot-template">
<div class="module_area md" code="{{=it.CODE}}">
	<div class="tit_area">
		<h2>{{=it.TITLE}}</h2>
	</div>
	{{=it.SUBMENU}}
...
<script id="foru_history_submenu_body" type="text/x-dot-template">
<div class="menu_two">
	<h2 class="blind">하위 카테고리</h2>
	{{=it.SUBMENU}}
</div>
</script>
<script id="foru_history_submenu_list" type="text/x-dot-template">
	<li data="{{=it.VALUE}}" {{? it.SELECTED == 'Y' }}class="on"{{?}}><a href="javascript:;">{{=it.LABEL}}</a></li>
</script>
<script id="foru_history_submenu_list_body" type="text/x-dot-template">
<ul data="{{=it.KEY}}">
	{{=it.LISTITEM}}
</ul>
</script>

<script id="foru_history_option_body" type="text/x-dot-template">
<div class="select_zone">
	{{=it.OPTION}}
</div>
</script>
<script id="foru_history_option_list_body" type="text/x-dot-template">
<div class="select_f" id="{{=it.OPTION_ID}}">
	<a href="javascript:;" class="v"><strong>{{=it.TITLE}}</strong><em></em></a>
	<ul class="sub_list" data="{{=it.KEY}}">
		{{=it.LISTITEM}}
	</ul>
</div>
</script>
<script id="foru_history_option_list" type="text/x-dot-template">
	<li data="{{=it.VALUE}}" {{? it.SELECTED == 'Y' }}selected="selected"{{?}}><a href="javascript:;">{{=it.LABEL}}</a></li>
</script>

<script id="message_foru_history_message" type="text/x-dot-template">
<div class="msg_area"><p>{{=it.MESSAGE}}</p></div>
</script>

<script id="foru_history_result_body" type="text/x-dot-template">
{{=it.MESSAGE}}
<div class="listarea{{? it.OPTION_OFF == 'Y' }} option_off{{?}}">
	<ul id="{{=it.ID}}" class="foryou_list">
		{{=it.LISTITEM}}
	</ul>
</div>
...
<script id="message_foru_history_result_error" type="text/x-dot-template">
<div class="msg_area"><p>{{? it.MESSAGE == '' }}일시적인 오류로 방송을 불러올 수 없습니다.{{??}}{{=it.MESSAGE}}{{?}}</p></div>
</script>
...
<li broad_no="{{=it.BROAD_NO}}">
	...
	<div class="cast_box">
	  ...
	  {{? it.DELETE == undefined || it.DELETE == 'Y' }}
...
<li>
	...
	<div class="cast_box">
		<a href="{{=it.VIEW_URL}}" onclick="javascript:{{=it.CLICK_FNC}}" class="box_link" target="_blank">
			...
			<span class="vtime">{{=it.VTIME}}</span>
			{{? it.FILE_TYPE == 'REVIEW' }}<span class="vod_type">다시보기</span>{{?}}
			{{? it.FILE_TYPE == 'HIGHLIGHT' }}<span class="hl_type">하이라이트</span>{{?}}
			<span class="subject">{{=it.SUBJECT}}</span>
			<span class="views"><em></em>{{=it.TOTAL_VIEW}} 명 시청</span>
		</a>
		<div class="nick_wrap">
...
<script id="tpl_foru_bj" type="text/x-dot-template">
<li>
	<!-- @@ -->
	<div class="bj_box">
		<a href="{{=it.STATION_URL}}" onclick="{{=it.CLICK_FNC}}" target="_blank">
			<span class="thumb">
				<img src="{{=it.STATION_LOGO}}" onerror="this.src='{{=it.THUMB_ERROR}}'" width="62" height="62" title="">
			</span>
			<span class="nick" user_id="{{=it.USER_ID}}">{{=it.USER_NICKSUB}}
			...
			<span class="afid">{{=it.USER_ID}}</span>
			<span class="date">최근방송 : {{=it.TIME}}</span>
		</a>
	</div>
	<!-- //@@ -->
</li>
