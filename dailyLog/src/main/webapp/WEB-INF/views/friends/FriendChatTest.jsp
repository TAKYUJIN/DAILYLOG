...
<input type="text" id="nickname" value = "${userNm}" style = "display:none">
 ...
 function send() {
  ...
  if(msg != ""){
	  message = {};
	  message.text_content = $("#message").val()
  	  message.friId = '${friId}'
  	  message.userId = '${userId}'
  	  message.class_Id = '${class_id}'
  	  message.text_sender = '${userId}'
  }
