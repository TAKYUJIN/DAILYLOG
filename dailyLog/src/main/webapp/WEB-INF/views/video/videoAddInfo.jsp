...
<body>
	...
	<div class="container">
	<div class="row">
				<div class="progress" style="width: 970px; margin-left:-170px;">
					<div class="progress-bar progress-bar-striped active"
						role="progressbar" aria-valuenow="40" aria-valuemin="0"
						aria-valuemax="100" style="width: 40%"></div>
				</div>
			...
			<button id="uploadbtn" class="btn btn-primary" type="submit" style="margin-top:-75px; margin-left:860px;">게시하기</button>
<div id="minor" style="margin-left:950px; width:300px;margin-bottom:-150px; ">
					<img id="minorimg" src="resources/images/family.png"
						style="width: 100px; position:sticky;"> <br> <a>동영상에 미성년자가 등장하는지
						살펴주세요<br> DailyLog에서의 아동 안전에 대한 정책과 <br>거주 지역의 모든 노동법
						의무를 준수해야합니다
					</a>
				</div>
...
<div id="info" style="margin-left:80px;"></div>
<input type="text" id="adInfo" name="adInfo" style="width: 960px; height:100px; margin-left:80px;" placeholder="추가정보를 입력해주세요 ">
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        (function(marker, places) {
            kakao.maps.event.addListener(marker, 'click', function() {
            	...
            	var message ="<ul> <li>"+places.place_name+"</li></ul>";
