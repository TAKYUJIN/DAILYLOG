...
<body>
	...
	<div class="main">	<div class="noticeEmail">
		<div class="col-lg-15">
		...
		<div>
			<a href="selectNoticeQuestion.no" class="noticeLink"
				style="float: right; width: 36%;"><h4 class="page-title4">나의
					문의내역</h4></a> <a href="noticeChattingQuestion.no" class="noticeLink"
				style="float: right; width: 12%;"><h4 class="page-title5">1:1문의</h4></a>
			<a href="noticeEmail.no" class="noticeLink"
				style="float: right; width: 15%;"><h4 class="page-title6">이메일
					문의</h4></a>
					...
					<div class="contact-form">
						...
						<form action="noticeEmailsending.no" method="post">
							...
							<div class="form-group">
								<label for="inputSubject">문의 제목</label> <input type="hidden"
									class="form-control" id="userId" name="userId"
									value="${loginUser.userId}" required> <input
									type="hidden" class="form-control" id="tomail" name="tomail"
									value="with.dailylog@gmail.com" required> <input
