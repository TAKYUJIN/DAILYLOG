...
public class Friend {
	...
	public Friend(String userId, String friId, String status_yn, String nickname, String fileNm) {
		super();
		this.userId = userId;
		this.friId = friId;
		this.status_yn = status_yn;
	...
	public String toString() {
		return "Friend [userId=" + userId + ", friId=" + friId + ", status_yn=" + status_yn + ", nickname=" + nickname
				+ ", fileNm=" + fileNm + "]";
	}
