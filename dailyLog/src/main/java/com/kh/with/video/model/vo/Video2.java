...
public class Video2 implements java.io.Serializable {
	...
	public Video2(int vNo, int userNo, String vTitle, int count, String chNm, String tag, String vblYn, Date uploadDt,
			Date modifyDt, String adultAut, String adYn, String adInfo, String location, String info, String filepath,
			String openTy, Loger loger, Reply reply) {
		super();
		this.vNo = vNo;
		this.userNo = userNo;
		this.vTitle = vTitle;
	...
	public String toString() {
		return "Video [vNo=" + vNo + ", userNo=" + userNo + ", vTitle=" + vTitle + ", count=" + count + ", chNm=" + chNm
				...
				+ ", info=" + info + ", filepath=" + filepath + ", openTy=" + openTy + ", loger=" + loger + ", reply="
				+ reply + "]";
	}
